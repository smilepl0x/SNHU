...
// Description : Hashtable proof of concept using bids imported from CSV file
// Class       : CS 260, 5-4 Programming Activity
//============================================================================
...
private:
    struct Node {
        ...
        // Initializes with a bid
        Node(Bid aBid) : Node() {
            bid = aBid;
        }

        // Initializes with a bid and a key
